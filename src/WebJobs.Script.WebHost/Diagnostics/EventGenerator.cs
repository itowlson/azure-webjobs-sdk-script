...
namespace Microsoft.Azure.WebJobs.Script.WebHost.Diagnostics
{
    ...
    {
        private const string TimeCreatedFormat = "MM/dd/yyyy hh:mm:ss.fff tt";
        ...
        {
            string timeCreated = DateTime.Now.ToString(TimeCreatedFormat);
            switch (level)
            {
                case TraceLevel.Verbose:
                    FunctionsEventSource.Instance.RaiseFunctionsEventVerbose(subscriptionId, appName, functionName, eventName, source, details, summary, ScriptHost.Version, timeCreated);
                    break;
                case TraceLevel.Info:
                    FunctionsEventSource.Instance.RaiseFunctionsEventInfo(subscriptionId, appName, functionName, eventName, source, details, summary, ScriptHost.Version, timeCreated);
                    break;
                case TraceLevel.Warning:
                    FunctionsEventSource.Instance.RaiseFunctionsEventWarning(subscriptionId, appName, functionName, eventName, source, details, summary, ScriptHost.Version, timeCreated);
                    break;
                case TraceLevel.Error:
                    ...
                    FunctionsEventSource.Instance.RaiseFunctionsEventError(subscriptionId, appName, functionName, eventName, source, details, summary, ScriptHost.Version, timeCreated);
                    break;
            }
        }

        public void LogFunctionMetricEvent(string subscriptionId, string appName, string eventName, long average, long minimum, long maximum, long count, DateTime timeCreated)
        {
            FunctionsEventSource.Instance.LogFunctionMetricEvent(subscriptionId, appName, eventName, average, minimum, maximum, count, ScriptHost.Version, timeCreated.ToString(TimeCreatedFormat));
        }
        ...
        public class FunctionsEventSource : EventSource
        {
            ...
            public void RaiseFunctionsEventVerbose(string subscriptionId, string appName, string functionName, string eventName, string source, string details, string summary, string hostVersion, string timeCreated)
            {
                if (IsEnabled())
                {
                    WriteEvent(65520, subscriptionId, appName, functionName, eventName, source, details, summary, hostVersion, timeCreated);
                }
            }

            [Event(65521, Level = EventLevel.Informational, Channel = EventChannel.Operational)]
            public void RaiseFunctionsEventInfo(string subscriptionId, string appName, string functionName, string eventName, string source, string details, string summary, string hostVersion, string timeCreated)
            {
                if (IsEnabled())
                {
                    WriteEvent(65521, subscriptionId, appName, functionName, eventName, source, details, summary, hostVersion, timeCreated);
                }
            }

            [Event(65522, Level = EventLevel.Warning, Channel = EventChannel.Operational)]
            public void RaiseFunctionsEventWarning(string subscriptionId, string appName, string functionName, string eventName, string source, string details, string summary, string hostVersion, string timeCreated)
            {
                if (IsEnabled())
                {
                    WriteEvent(65522, subscriptionId, appName, functionName, eventName, source, details, summary, hostVersion, timeCreated);
                }
            }

            [Event(65523, Level = EventLevel.Error, Channel = EventChannel.Operational)]
            public void RaiseFunctionsEventError(string subscriptionId, string appName, string functionName, string eventName, string source, string details, string summary, string hostVersion, string timeCreated)
            {
                if (IsEnabled())
                {
                    WriteEvent(65523, subscriptionId, appName, functionName, eventName, source, details, summary, hostVersion, timeCreated);
                }
            }

            [Event(65524, Level = EventLevel.Informational, Channel = EventChannel.Operational)]
            public void LogFunctionMetricEvent(string subscriptionId, string appName, string eventName, long average, long minimum, long maximum, long count, string hostVersion, string timeCreated)
            {
                if (IsEnabled())
                {
                    WriteEvent(65524, subscriptionId, appName, eventName, average, minimum, maximum, count, hostVersion, timeCreated);
                }
            }
        }
    }
